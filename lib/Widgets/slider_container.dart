...
class SliderContainer extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    const Padding(
      ...
      child: Text(
      "20% Discount",
      style: TextStyle(fontWeight: FontWeight.w600, fontSize: 30, fontFamily: 'Work Sans'),
      ),
    ),
    const Padding(
    ...
    "On your first purchase",
      style: TextStyle(fontSize: 14, fontWeight: FontWeight.w400, fontFamily: 'Work Sans',),
    ),
    ),
    ElevatedButton(
